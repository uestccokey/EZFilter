...
public class GLConfigChooser implements GLSurfaceView.EGLConfigChooser {
    ...
    private static int[] sConfigSpec =
            {
    ...
    public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
        ...
        egl.eglChooseConfig(display, sConfigSpec, null, 0, num_config);
        ...
        egl.eglChooseConfig(display, sConfigSpec, configs, numConfigs, num_config);
